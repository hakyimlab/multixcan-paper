...
(function(){
  ...
  (significant_discoveries_bar_plot(scz2_multi_predixcan_, scz2_predixcan, "Brain_Cerebellum") + ggplot2::ggtitle("Number of significant genes", subtitle="PGC Schizophrenia")) %>%
