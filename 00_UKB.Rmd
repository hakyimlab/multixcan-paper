...
(function() {
  p <- chol_predixcan %>% 
    ...
    p_save_delim(file.path(results_dir, "ukb_high_cholesterol_predixcan_significant.txt"))
  ...
  mtp <- chol_multi_predixcan %>% 
    ...
    p_save_delim(file.path(results_dir, "ukb_high_cholesterol_multi_predixcan_significant.txt"))
