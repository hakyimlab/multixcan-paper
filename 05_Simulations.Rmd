...
(function(){
  mt_30_ <- "data/simulations/single_tissue__ccn30_cc5__mt_results.txt" %>% load_d_("multixcan", "c")
  #mt_1_ <- "data/simulations/single_tissue__ccn1_cc10__mt_results.txt" %>% load_d_("multixcan", "b")
  mt_0_ <- "data/simulations/single_tissue__ccn0_cc5__mt_results.txt" %>% load_d_("multixcan", "a")
  p_ <- "data/simulations/single_tissue__ccn0_cc5__p_results.txt" %>% load_d_("predixcan", "d")
  ...
  subtitle <- expression(Y==5%*%N(0,1)+t[Whole~Blood])
...
(function(){
  mt_30_ <- "data/simulations/combination_brain__ccn30_cc5__mt_results.txt" %>% load_d_("multixcan", "c")
  #mt_1_ <- "data/simulations/combination_brain__ccn1_cc5__mt_results.txt" %>% load_d_("multixcan", "b")
  mt_0_ <- "data/simulations/combination_brain__ccn0_cc5__mt_results.txt" %>% load_d_("multixcan", "a")
  mt_t_ <- "data/simulations/combination_brain_truth__cc5__mt_results.txt" %>% load_d_("multixcan", "d") 
  p_ <- "data/simulations/combination_brain__ccn0_cc5__p_results.txt" %>% load_d_("predixcan", "e") %>% 
    group_by(gene) %>% top_n(n=1, wt=pvalue) %>% data.frame
  ...
  subtitle <- expression(Y==5%*%N(0,1)+frac(1,sqrt(5))%*%sum(t[i], i=1, 5))
  p <- the_box_plot_(d) + xlab("Method") + ylab(expression(Significance~(-log10(pvalue)))) + 
...
(function(){
  mt_30_ <- "data/simulations/combination_all_1kr__ccn30_cc5__mt_results.txt" %>% load_d_("multixcan", "c")
  mt_0_ <- "data/simulations/combination_all_1kr__ccn0_cc5__mt_results.txt" %>% load_d_("multixcan", "a")
  #mt_1_ <- "data/simulations/combination_all_1kr__ccn1_cc30__mt_results.txt" %>% load_d_("multixcan", "b")
  #mt_t_ <- "data/simulations/combination_all_1kr_truth__ccn30_cc5__mt_results.txt" %>% load_d_("multixcan", "d") 
  p_ <- "data/simulations/combination_all_1kr__ccn30_cc5__p_results.txt" %>% load_d_("predixcan", "e") %>% 
    group_by(gene) %>% top_n(n=1, wt=pvalue) %>% data.frame
  ...
  subtitle <- expression(Y==5%*%N(0,1)+frac(1,sqrt(p))%*%sum(t[i], i=1, p))
  p <- the_box_plot_(d) + xlab("Method") + ylab(expression(Significance~(-log10(pvalue)))) + 
    ggtitle(title, subtitle = subtitle)
...
(function(){
  mt_30_ <- "data/simulations/combination_all_1kr__ccn30_cc5__mt_results.txt" %>% load_mt_("multixcan", "condition number 30") %>% select(gene, pvalue, label, n_models) %>% mutate(facet = "All tissues as causal")
  mt_0_ <- "data/simulations/combination_all_1kr__ccn0_cc5__mt_results.txt" %>% load_mt_("multixcan", "None") %>% select(gene, pvalue, label, n_models) %>% mutate(facet = "All tissues as causal")

  mtb_30_ <- "data/simulations/combination_brain__ccn30_cc5__mt_results.txt" %>% load_mt_("multixcan", "condition number 30") %>% select(gene, pvalue, label, n_models) %>% mutate(facet = "5 Brain Tissues as causal")
  mtb_0_ <- "data/simulations/combination_brain__ccn0_cc5__mt_results.txt" %>% load_mt_("multixcan", "None") %>% select(gene, pvalue, label, n_models) %>% mutate(facet = "5 Brain Tissues as causal")
...
(function(){
  ...
  d <- rbind(d1, d2)#, d3)
  d$label <- factor(d$label, levels=seq(0,100,10), labels=c("No\nregularization", seq(10,100,10)))
  p <- the_box_plot_(d) + xlab("Condition number") + ylab(expression(Significance~(-log10(pvalue)))) + 
    ggtitle("Significance", subtitle="Different regularization thresholds") + facet_wrap(~the_facet, ncol=1, scales="free")
